...
-   September 21: Full pipeline seemingly functioning with more complicated model. Believe the summaries I need to calculate are coded. BUT: need to work back through the full pipeline tomorrow and then set up runs.
